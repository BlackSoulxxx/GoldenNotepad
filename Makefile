...
ARCH		?=arm
CROSS_COMPILE	?= ../Toolchain/Toolchain_5.3/bin/arm-cortex-linux-gnueabi-
...
TWEAK        = -mvectorize-with-neon-quad -ftree-vectorize -mcpu=cortex-a15.cortex-a7 -mfpu=neon-vfpv4
HOSTCC       = gcc
HOSTCXX      = g++
